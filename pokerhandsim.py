...
print('Board: ', table.show_board())
print('Seat1 hand: {}{} {}{}'.format(table.seat1.hand[0].rank[0], table.seat1.hand[0].suit, table.seat1.hand[1].rank[0],
...
print('Seat2 hand: {}{} {}{}'.format(table.seat2.hand[0].rank[0], table.seat2.hand[0].suit,
                                     table.seat2.hand[1].rank[0],
...
print('Seat3 hand: {}{} {}{}'.format(table.seat3.hand[0].rank[0], table.seat3.hand[0].suit,
                                     table.seat3.hand[1].rank[0],
...
print('Seat4 hand: {}{} {}{}'.format(table.seat4.hand[0].rank[0], table.seat4.hand[0].suit,
                                     table.seat4.hand[1].rank[0],
...
print('Seat5 hand: {}{} {}{}'.format(table.seat5.hand[0].rank[0], table.seat5.hand[0].suit,
                                     table.seat5.hand[1].rank[0],
...
print('Seat6 hand: {}{} {}{}'.format(table.seat6.hand[0].rank[0], table.seat6.hand[0].suit,
                                     table.seat6.hand[1].rank[0],
