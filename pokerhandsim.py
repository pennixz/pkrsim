...
print(table.eval_quads(table.seat1.hand))
print(table.eval_trips(table.seat1.hand))
print(table.eval_pairs(table.seat1.hand))
print(table.eval_high_card(table.seat1.hand).rank[1])
